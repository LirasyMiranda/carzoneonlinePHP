...
<header class="header-mobile">
    ...
    <!-- Fondo mobile -->
<div class="carrusel div-fondo-mobile">
...
<main class="main-1">
    <section class="section-1">
        <!-- img escritorio -->
        <img class="img-regulares-escritorio" src="regulares-.jpg" alt="">
        <div>
            <span style="color: rgb(75, 75, 75);">Categoria ecónomica</span>
            <h2 class="h2-regulares">Regulares</h2>
            <h3 class="section-h3">
                Nuestros modelos de autos de categoría Regulares, como el Volkswagen GTI y el BMW M1, representan la perfecta combinación de rendimiento y accesibilidad.
            </h3>
            <p class="p">
                El Volkswagen GTI es un ícono del diseño compacto con un motor turbo eficiente que ofrece una conducción ágil y dinámica, ideal para quienes buscan emoción en el día a día. Por otro lado, el BMW M1 destaca por su potencia refinada y su elegancia deportiva, brindando una experiencia de manejo superior sin comprometer la comodidad. Ambos modelos reflejan nuestro compromiso con la calidad y la innovación, ofreciendo vehículos que se adaptan tanto a la rutina diaria como a la carretera abierta.
            </p>
        </div>
        <!-- img mobile -->
        <img class="img-regulares-mobile" src="regulares-.jpg" alt="">
    </section>


    <!-- MODELOS -->
     <section id="mod" class="section-modelos">
        <h1 class="h1-regulares">Modelos Regulares.</h1>
        <div class="div-modelos">
            <div class="card">
                <div class="capa-card1">
                    <div class="nombres-modelos">
                        <h3>Potencia y estilo en cada curva.</h3>
                        <h1>Volkswagen Golf GTI 2024</h1>
                        <div>
                        <h2 class="precios">
                                <span>$60 </span><span style="background: hsl(184, 40%, 57%);" class="semana">/$400 semana</span>
                            </h2>
                            <a href="VolkswagenGTI.php"><button class="button">Explorar</button></a>
                            <a href="consulta.php"><button class="btn">Consultar</button></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="capa-card2">
                    <div class="nombres-modelos">
                        <h3>Adrenalina y lujo en perfecta armonía.</h3>
                        <h1>BMW 1m 2012</h1>
                        <div>
                        <h2 class="precios">
                                <span>$60 </span><span style="background: hsl(184, 40%, 57%);" class="semana">/$400 semana</span>
                            </h2>
                            <a href="bmwm1.php"><button class="button bmw">Explorar</button></a>                                           
                            <a href="consulta.php"><button class="btn bmw">Consultar</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="eleccion modelos">
                    ...
                    <div class="inputs div-amodelos">
                        ...
                        <select class="amodelos amodelos-modelos" name="Elige el modelo" id="">
                            <option value="">Volkswagen GTI</option>
                            <option value="">BMW 1m</option>
                        </select>
                    </div>
                </div>
